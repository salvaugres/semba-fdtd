...
integer function test_jsonfortran() result(error_cnt)
    use utils
    ...
    !character(len=*),parameter :: dir = 'src_json_parser/testData/'
    ...
    error_cnt = 0
    write(error_unit,'(A)') 'Hello from test json fortran'
    ...
    ! parse the json file:
    write(error_unit,'(A)') ''
    write(error_unit,'(A)') 'parsing file '//filename
