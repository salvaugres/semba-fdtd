...
# Directories
#-----------------------------------------------------------------------------
set (${LIBAEC_PACKAGE_NAME}_INCLUDE_DIR "${PACKAGE_${CMAKE_FIND_PACKAGE_NAME}_COUNTER_4}/include")

set (${LIBAEC_PACKAGE_NAME}_SHARE_DIR "${PACKAGE_${CMAKE_FIND_PACKAGE_NAME}_COUNTER_4}/cmake")
set_and_check (${LIBAEC_PACKAGE_NAME}_BUILD_DIR "${PACKAGE_${CMAKE_FIND_PACKAGE_NAME}_COUNTER_4}")
...
if (NOT TARGET "libaec")
  include (${PACKAGE_${CMAKE_FIND_PACKAGE_NAME}_COUNTER_4}/cmake/libaec-targets.cmake)
endif ()
