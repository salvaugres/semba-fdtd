...
# Directories
#-----------------------------------------------------------------------------
set (${ZLIB_PACKAGE_NAME}_INCLUDE_DIR "${PACKAGE_${CMAKE_FIND_PACKAGE_NAME}_COUNTER_2}/include")

set (${ZLIB_PACKAGE_NAME}_SHARE_DIR "${PACKAGE_${CMAKE_FIND_PACKAGE_NAME}_COUNTER_2}/cmake")
set_and_check (${ZLIB_PACKAGE_NAME}_BUILD_DIR "${PACKAGE_${CMAKE_FIND_PACKAGE_NAME}_COUNTER_2}")
...
#-----------------------------------------------------------------------------
if (NOT TARGET "zlib")
  include (${PACKAGE_${CMAKE_FIND_PACKAGE_NAME}_COUNTER_2}/cmake/zlib-targets.cmake)
endif ()
